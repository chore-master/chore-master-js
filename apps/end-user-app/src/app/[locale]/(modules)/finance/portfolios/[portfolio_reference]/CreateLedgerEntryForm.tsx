...
import { Asset, CreateLedgerEntryFormInputs, Instrument } from '@/types/finance'
...
export default function CreateLedgerEntryForm({
  ...
  handleSubmitCreateLedgerEntryForm: SubmitHandler<CreateLedgerEntryFormInputs>
}) {
  const isParentLedgerEntryExisted = !!createLedgerEntryForm.watch(
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    error={!!createLedgerEntryForm.formState.errors.entry_time}
                    helperText={
                      createLedgerEntryForm.formState.errors.entry_time?.message
                    }
                  />
                )}
                rules={{
